...
const PaymentVoucher = () => {
  ...
  const canCreate = hasPermission('voucher.payment.create') || true;
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      Swal.fire({ position: 'top-end', icon: 'success', title: 'Payment posted', showConfirmButton: false, timer: 1200, toast: true });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-gray-800">Payment Voucher Posting</h2>
      </div>
      ...
      <div className="overflow-hidden bg-white rounded-xl border border-gray-200 shadow-sm">
        <form onSubmit={submit}>
          ...
          <div className="px-6 py-3 bg-gray-50 flex justify-end">
            <button type="submit" className="px-4 py-2 rounded-md bg-blue-600 text-white">Post Payment</button>
          </div>
        </form>
      </div>
    </div>
