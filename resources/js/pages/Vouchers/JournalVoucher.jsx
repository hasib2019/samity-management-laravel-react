...
const JournalVoucher = () => {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      await api.post('/journal-voucher', payload);
      Swal.fire({ position: 'top-end', icon: 'success', title: 'Journal posted', showConfirmButton: false, timer: 1200, toast: true });
      setForm({ 
          tran_date: new Date().toISOString().slice(0, 10), 
          amount: '', 
          dr_gl_id: '', 
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold text-gray-800">Journal Voucher</h2>
      </div>
