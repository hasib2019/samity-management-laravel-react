...
class JournalVoucherController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Smart Balance Check
        $crGl = GlAccount::find($request->cr_gl_id);
        
        // If we are crediting an Asset (1) or Expense (4), we are reducing its balance.
        // So we must ensure it has enough balance (Dr - Cr >= Amount).
        // BalanceHelper returns (Dr - Cr) for these types.
        ...
        // If we are crediting Liability (2) or Income (3), we are increasing its balance (Cr - Dr).
        // So generally no balance check is needed against "available funds".
