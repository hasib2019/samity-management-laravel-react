...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'gl_principal_id' => 'nullable|exists:glac_mst,id',
            'gl_loan_outstanding_id' => 'nullable|exists:glac_mst,id',
            'gl_loan_disbursement_id' => 'nullable|exists:glac_mst,id',
            'gl_profit_id' => 'nullable|exists:glac_mst,id',
            'gl_penalty_id' => 'nullable|exists:glac_mst,id',
            'gl_income_id' => 'nullable|exists:glac_mst,id',
            'gl_expense_id' => 'nullable|exists:glac_mst,id',
